...
<section class="py-10 bg-white">
    <div class="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 px-4">
        ...
        <div class="bg-blue-900 p-5 rounded-lg text-white text-center">
            ...
            <img src="{{ asset('images/products/pedigree_adult.jpg') }}"
                 class="mx-auto w-60 h-50 object-cover rounded">
            <p class="mt-4 text-sm">20% on all orders above LKR.5000</p>
        </div>

        <div class="bg-blue-900 p-5 rounded-lg text-white text-center">
            <h3 class="text-xl font-bold mb-3">CAT FOOD</h3>
            <img src="{{ asset('images/products/whiskas_dry.jpg') }}"
                 class="mx-auto w-60 h-50 object-cover rounded">
...
<!-- SHOP BY PET -->
<div class="text-center mt-4">
    <button class="bg-blue-900 text-white px-6 py-2 rounded-md text-lg">
        Shop By Pet
    </button>
</div>

<section class="flex justify-center gap-6 flex-wrap mt-8">
    <a href="{{ route('products.category', 'cats') }}"
       class="bg-blue-300 px-12 py-12 rounded-xl font-bold shadow text-3xl">CAT</a>

    <a href="{{ route('products.category', 'dogs') }}"
       class="bg-blue-300 px-12 py-12 rounded-xl font-bold shadow text-3xl">DOG</a>

    <a href="{{ route('products.category', 'fish') }}"
       class="bg-blue-300 px-12 py-12 rounded-xl font-bold shadow text-3xl">FISH</a>

    <a href="{{ route('products.category', 'birds') }}"
       class="bg-blue-300 px-12 py-12 rounded-xl font-bold shadow text-3xl">BIRD</a>
</section>

<!-- DEALS SECTION -->
<div class="text-center mt-10">
    <button class="bg-blue-900 text-white px-12 py-2 rounded-md text-lg">
        DEALS
    </button>
</div>

<section class="flex justify-center flex-wrap gap-6 mt-8">
    <a href="{{ route('products.deal', 'clearance') }}"
       class="bg-blue-200 px-6 py-3 rounded-full">CLEARANCE SALE</a>

    <a href="{{ route('products.deal', 'discount') }}"
       class="bg-blue-200 px-6 py-3 rounded-full">DISCOUNT ITEMS</a>
</section>
...
<section class="py-10">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-10 max-w-6xl mx-auto px-4">
        ...
        <div class="text-center">
            <img src="{{ asset('images/products/cartoon1.jpg') }}"
                 class="mx-auto w-40">
            <p class="mt-3 font-semibold">Same Day Delivery</p>
        </div>

        <div class="text-center">
            <img src="{{ asset('images/products/fast-delivery.png') }}"
                 class="mx-auto w-40">
